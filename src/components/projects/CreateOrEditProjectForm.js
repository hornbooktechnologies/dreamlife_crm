...
const getSchema = (type) =>
  z.object({
    ...
    project_technology: z.string().min(1, "Please enter project type"),
...
const CreateOrEditProjectForm = ({
  ...
  const onSubmit = async (data) => {
    try {
      const url =
        type === "edit" ? `/projects/${editableProject.id}` : "/projects";
      ...
      if (
        ...
        showSuccessToast(
          response.message ||
            `Project ${type === "edit" ? "updated" : "created"} successfully`,
        );
        setIsOpen(false);
            ...
            <>
                                ...
                                companies
                                  ...
                                  .map((comp) => (
                                    ...
                                    >
                                      {comp}
                                      {field.value === comp && (
                                        <Check className="ml-auto h-4 w-4 text-[#3a5f9e]" />
                                      )}
                                    </DropdownMenuItem>
                                  ))
                              ) : (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      render={({ field }) => (
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              variant="outline"
                              className="w-full justify-between items-center font-normal border-gray-300 hover:bg-white focus:border-[#3a5f9e]"
                            >
                  ...
                  <div className="space-y-2">
                            ...
                            .map((user) => {
                              ...
                              return (
                                <DropdownMenuCheckboxItem
                                  ...
                                  checked={isSelected}
                                  onCheckedChange={() => {
                                    setValue("project_developer", userName, {
                                      shouldValidate: true,
                                    });
                                  }}
                                  className="cursor-pointer focus:bg-[#3a5f9e]/10 focus:text-[#3a5f9e] data-[state=checked]:bg-[#3a5f9e]/20 data-[state=checked]:text-[#3a5f9e]"
                    ...
                    {errors.project_developer && (
                      <p className="text-red-500 text-xs mt-1">
                        {errors.project_developer.message}
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    {errors.project_technology && (
                      <p className="text-red-500 text-xs mt-1">
                        {errors.project_technology.message}
                      </p>
                    )}
                  </div>
              ...
              <DialogFooter className="p-6 border-t bg-gray-50/50 mt-auto flex flex-col gap-3 sm:flex-row sm:gap-2 sm:justify-end">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-primary via-primary-hover to-primary text-white"
                >
                  {isSubmitting
                    ? "Saving..."
                    : type === "edit"
